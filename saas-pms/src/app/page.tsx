  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="bg-white border-b border-gray-100 py-4 px-8 flex justify-between items-center">
        ...
        <div>
          {session ? (
            <Link href="/dashboard/pos" className="flex items-center space-x-2 text-indigo-600 font-medium hover:text-indigo-800 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 text-center">
        ...
        <div className="flex justify-center space-x-4">
          <Link href={session ? "/dashboard/pos" : "/login"} className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-full font-semibold flex items-center transition-colors shadow-lg shadow-indigo-200">
